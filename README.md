...
[![Download for Windows](https://img.shields.io/badge/Download-Windows-0078D6?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/ghauri01/OpsMaxx/releases/download/v0.1.0/OpsMaxx-0.1.0-setup.exe)
[![Download for macOS Apple Silicon](https://img.shields.io/badge/Download-macOS%20Apple%20Silicon-000000?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/ghauri01/OpsMaxx/releases/download/v0.1.0/OpsMaxx-0.1.0-arm64.dmg)
[![Download for macOS Intel](https://img.shields.io/badge/Download-macOS%20Intel-555555?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/ghauri01/OpsMaxx/releases/download/v0.1.0/OpsMaxx-0.1.0-x64.dmg)
[![Download for Linux](https://img.shields.io/badge/Download-Linux%20AppImage-FCC624?style=for-the-badge&logo=linux&logoColor=black)](https://github.com/ghauri01/OpsMaxx/releases/download/v0.1.0/OpsMaxx-0.1.0-x86_64.AppImage)

**[⬇ All downloads and checksums](https://github.com/ghauri01/OpsMaxx/releases/latest)** — portable `.exe`, `.deb` and every SHA-256.

[![Latest release](https://img.shields.io/github/v/release/ghauri01/OpsMaxx?label=latest&sort=semver)](https://github.com/ghauri01/OpsMaxx/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/ghauri01/OpsMaxx/total?label=downloads)](https://github.com/ghauri01/OpsMaxx/releases)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Platforms](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey)](https://github.com/ghauri01/OpsMaxx/releases/latest)
[![Stars](https://img.shields.io/github/stars/ghauri01/OpsMaxx?style=flat)](https://github.com/ghauri01/OpsMaxx/stargazers)

[Features](#features) · [Install](#install) · [Quick start](#quick-start) · [Comparison](#opsmaxx-vs-mobaxterm-putty-termius-and-securecrt) · [Workspaces](#workspaces) · [Command palette](#command-palette) · [Shortcuts](#keyboard-shortcuts) · [Databases](#databases) · [Vault](#vault) · [FAQ](#faq) · [Contributing](#contributing) · [Licence](#licence)

</div>

---

OpsMaxx is a **free and open-source alternative to MobaXterm, PuTTY, Termius, SecureCRT and MobaXterm Personal Edition**, built for engineers who spend the day moving between bastions, production boxes and databases. It combines an **SSH terminal**, **SFTP file browser**, **server monitoring**, **SSH tunnels**, a **multi-engine database client** and an **encrypted password vault** in a single window — with no account, no telemetry and no subscription.
...
| Platform | File | Notes |
|---|---|---|
| **Windows 10/11** | [`OpsMaxx-0.1.0-setup.exe`](https://github.com/ghauri01/OpsMaxx/releases/download/v0.1.0/OpsMaxx-0.1.0-setup.exe) | Installer, desktop + Start-menu shortcut. Pick this one if unsure. |
| **Windows (portable)** | [`OpsMaxx-0.1.0-portable.exe`](https://github.com/ghauri01/OpsMaxx/releases/download/v0.1.0/OpsMaxx-0.1.0-portable.exe) | Single file, no install, keeps its data beside the `.exe` — runs from a USB stick |
| **macOS (Apple Silicon)** | [`OpsMaxx-0.1.0-arm64.dmg`](https://github.com/ghauri01/OpsMaxx/releases/download/v0.1.0/OpsMaxx-0.1.0-arm64.dmg) | M1 and later |
| **macOS (Intel)** | [`OpsMaxx-0.1.0-x64.dmg`](https://github.com/ghauri01/OpsMaxx/releases/download/v0.1.0/OpsMaxx-0.1.0-x64.dmg) | Intel Macs |
| **Linux** | [`OpsMaxx-0.1.0-x86_64.AppImage`](https://github.com/ghauri01/OpsMaxx/releases/download/v0.1.0/OpsMaxx-0.1.0-x86_64.AppImage) | `chmod +x OpsMaxx-0.1.0-x86_64.AppImage` and run — works on any distribution |
| **Linux (Debian / Ubuntu)** | [`OpsMaxx-0.1.0-amd64.deb`](https://github.com/ghauri01/OpsMaxx/releases/download/v0.1.0/OpsMaxx-0.1.0-amd64.deb) | `sudo apt install ./OpsMaxx-0.1.0-amd64.deb` |
...
| `latest.yml`, `latest-mac.yml`, `latest-linux.yml` | The update feed for each platform: the current version number, the file names and their checksums. Published automatically by `electron-builder`. | **No.** OpsMaxx does not auto-update yet — check back here for new versions. |
...
```bash
sha256sum OpsMaxx-0.1.0-x86_64.AppImage    # Linux
shasum -a 256 OpsMaxx-0.1.0-arm64.dmg      # macOS
```

```powershell
Get-FileHash OpsMaxx-0.1.0-setup.exe -Algorithm SHA256    # Windows
```

> The builds are **not code-signed**. Windows SmartScreen will warn on first run — choose *More info → Run anyway*. On macOS, run `xattr -cr /Applications/OpsMaxx.app` if Gatekeeper blocks it.
...
On Windows, `OpsMaxx-0.1.0-setup.exe` unless you specifically want the
...
`xattr -cr /Applications/OpsMaxx.app`. The source is public if you would rather build it
yourself.
...
[⬇ Download OpsMaxx](https://github.com/ghauri01/OpsMaxx/releases/latest) · [🐞 Report a bug](https://github.com/ghauri01/OpsMaxx/issues/new/choose) · [💬 Discussions](https://github.com/ghauri01/OpsMaxx/discussions) · [📧 Contact](mailto:aliwaqarofficial@gmail.com)
