...
| `tsnet` / Tailscale (linked into `opsmaxx-netd`) | pinned in `sidecar/netd/go.mod` | BSD-3-Clause | all | `tailscale.com` |
| `ngrok-go` (linked into `opsmaxx-netd`) | pinned in `sidecar/netd/go.mod` | MIT | all | `golang.ngrok.com/ngrok/v2` |
