...
|---|---|---|---|
| `opsmaxx-netd` | in-tree | MIT | `sidecar/netd/` in this repository |
...
OpenVPN 2.x is **GPL-2.0** and OpsMaxx is MIT. OpsMaxx supports OpenVPN by detecting a copy the user has already
