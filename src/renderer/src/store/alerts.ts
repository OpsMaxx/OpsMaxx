 ...
 * lands, `OpsMaxxApi` carries the namespace, this body becomes
 * `window.opsmaxx?.runbooks`, and the cast is deleted. A function rather
...
function runbooksBridge(): Partial<RunbooksBridge> | undefined {
  return (window.opsmaxx as unknown as { runbooks?: Partial<RunbooksBridge> } | undefined)
    ?.runbooks
}
