    ...
    <div className="bc-panel">
      ...
      {summary.withFacts === 0 ? (
        <div className="s-desc">
          <b>No host facts have been collected yet.</b> OpsMaxx collects them about once an
        ...
        <>
          <div className="row wrap muted" style={{ fontSize: 11, marginTop: 8, gap: 12 }}>
            ...
            {summary.staleMetadata > 0 && (
              <span
                className="warn"
                title="OpsMaxx never refreshes a package cache — refreshing is a network operation and on some package managers it can break the host — so a count read out of an old cache is reported with the cache's age beside it rather than silently presented as current."
              >
