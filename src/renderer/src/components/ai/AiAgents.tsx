    ...
    return (
      <div className="settings-section" style={{ marginBottom: 24 }}>
        ...
        <div className="s-desc">
          This token is shown only once. OpsMaxx stores only its hash — if you lose it, revoke
          ...
          just run <code className="mono">opsmaxx claude</code> or{' '}
          <code className="mono">opsmaxx codex</code>; its one-time pairing code replaces
...
export function AiAgents({ sessionsOnly = false }: { sessionsOnly?: boolean }): React.JSX.Element {
  ...
  return (
    <div className="settings-section">
      ...
      <div className="sub">
        {sessionsOnly
          ? 'Every agent currently authorized to talk to OpsMaxx, with its workspace and access group.'
