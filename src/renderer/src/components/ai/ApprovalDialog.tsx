 ...
 * than 0: "this session has taken no actions" and "OpsMaxx could not find
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            ...
            <Row label="What led to this">
              {/* The bridge does not carry an intent, and this line says so
                  ...
                  the truth is a claim about OpsMaxx. */}
              <span style={{ color: 'var(--warn)' }}>
                Not recorded. OpsMaxx’s bridge does not ask an agent what it is trying to achieve, so nothing here
