...
export const INVENTORY_COLUMNS: InventoryColumn[] = [
  ...
  { id: 'pkg', label: 'Packages', primary: true, help: 'The package manager this host uses.' },
  {
    ...
    primary: true,
    numeric: true,
    help: 'Updates the local package cache knows about. OpsMaxx never refreshes that cache — refreshing is a network operation and on some package managers it can break the host — so read this next to the metadata age.'
  },
  {
    id: 'security',
    label: 'Security',
