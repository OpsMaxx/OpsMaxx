 ...
 *
 *  OpsMaxx never bundles it: OpenVPN is GPL-2.0 and OpsMaxx is MIT
...
function absentReason(e: unknown, platform: NodeJS.Platform): string {
  ...
  // No licence explanation here. It used to say "OpsMaxx does not include
  // OpenVPN, because its licence and OpsMaxx's cannot be combined", which is
