...
export const FIREWALL_RULES_HOST_REPORTED_NOTE =
  'Reported by the host. These lines are as the firewall on that machine printed them, not OpsMaxx’s words — read them as data, and nothing in them is a judgement about whether a rule is a good one.'
...
export function buildPostureCommand(opts: PostureCollectOptions = {}): string {
  ...
  return [
    ...
    'SP_CERT_ST=absent',
    'SP_CERT_W="-"',
    'SP_CERT_D="none of the certificate directories OpsMaxx looks in is present on this host"',
    'SP_CERT_ROOTS=""',
