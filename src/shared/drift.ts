...
export const DRIFT_RULES: DriftRule[] = [
  ...
  },
  {
    ...
    detail:
      "Replaces this host's hostname, its short name and the server's name in OpsMaxx with a placeholder, case-insensitively. A template that stamps the machine's name into a file makes every copy unique; this is what makes them comparable. It cannot see a per-host name it was not told about.",
