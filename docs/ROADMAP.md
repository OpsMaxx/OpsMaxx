...
| **Capacity** | cpu/memPct/diskPct trends over 7 d full + 90 d hourly, forecast with eight refusals and a 90-day horizon | No K8s allocatable-vs-requested; no fleet-level "N hosts cross in 30 days"; nothing over MCP | 47 |
